...
PER_JOINT_SCALE = np.array([
    ...
    0.25, 0.25, 0.25, 0.25, 0.25, 0.25,      # L_hip_pitch, L_hip_roll, L_hip_yaw, L_knee, L_ankle_pitch, L_ankle_roll
    0.25, 0.25, 0.25, 0.25, 0.25, 0.25,      # R_hip_pitch, R_hip_roll, R_hip_yaw, R_knee, R_ankle_pitch, R_ankle_roll
    0.25,                                      # torso_yaw
], dtype=np.float64)
POLICY_HZ = 100.0
PHYSICS_HZ = 500.0
