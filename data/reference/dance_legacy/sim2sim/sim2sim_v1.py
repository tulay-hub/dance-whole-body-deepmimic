...
xml_dir_path = os.path.join(BASE_DIR, "../../../lumos_ws/lumos_rl_gym/resources")
xml_path = '/home/congzz/workspace/BeyondMimic/scripts/ASE/ase/assets/lumos/nix1/mjcf/nix1_v2_joint21.xml'
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            if counter % control_decimation == 0:
                ...
                motion_body_pos_cur = motion_body_pos[timestep,9,:]
                motion_body_quat_cur = motion_body_quat[timestep,9,:]
                anchor_pos, anchor_quat = subtract_frame_transforms_mujoco(position, quaternion, motion_body_pos_cur, motion_body_quat_cur)
                ...
                obs[0: 42] = command
                obs[42:42 +  6] = anchor_ori
                obs[48:48 +  3] = d.qvel[3 : 6]
                obs[51:51 + 21] = joint_pos - joint_pos_seq
                obs[72:72 + 21] = joint_vel
                obs[93:93 + 21] = action_buffer
